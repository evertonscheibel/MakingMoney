...
export const companiesApi = {
    ...
    addSector: async (id: string, sector: string): Promise<Company> => {
        return apiCall<Company>('post', `/companies/${id}/sectors`, { sector });
    },
...
export const processesApi = {
    ...
    getSchedule: async (period: string, sector?: string): Promise<Process[]> => {
        return apiCall<Process[]>('get', '/schedule', { period, sector });
    },
