...
const processes = [
    ...
    { title: 'IMPOSTOS RETIDOS RETIDOS EM SERVIÇOS DE ABATE', sector: 'Fiscal', code: 'FIS-007' },
    { title: 'PREVISAO DE IMPOSTOS', sector: 'Fiscal', code: 'FIS-008' },
    { title: 'BALANÇO FISCAL', sector: 'Fiscal', code: 'FIS-009' },
    { title: 'TAXA DE SERVIÇO DE ABATE', sector: 'Produção', code: 'PRD-005' },
    ...
    { title: 'INCLUSÃO FINANCEIRA TAXA DE SERVIÇOS DE ABATE', sector: 'Financeiro', code: 'FIN-007' },
    { title: 'EMAIL SERVIÇO DE ABATE', sector: 'Administrativo', code: 'ADM-002' },
    ...
    { title: 'RESULTADO SERVIÇO DE ABATE E DESOSSA', sector: 'Controladoria', code: 'CON-002' },
